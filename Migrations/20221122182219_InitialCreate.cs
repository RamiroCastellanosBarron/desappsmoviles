        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LanguageRoleId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieLanguages_LanguageRoles_LanguageRoleId",
                        column: x => x.LanguageRoleId,
                        principalTable: "LanguageRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieCasts_Genders_GenderId",
                        column: x => x.GenderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieLanguages_LanguageRoleId",
                table: "MovieLanguages",
